...
type Portal = "operations" | "driver" | "parent" | "events";
...
export default function RouteFlowApp() {
  ...
  const [portal, setPortal] = useState<Portal>("operations");
    ...
    <div className="app-shell">
      <aside className="sidebar" aria-label="RouteFlow navigation">
        ...
        <nav className="nav-tabs" aria-label="Views">
          <button className={`nav-tab ${portal === "operations" ? "active" : ""}`} onClick={() => setPortal("operations")} type="button">Admin</button>
          <button className={`nav-tab ${portal === "driver" ? "active" : ""}`} onClick={() => setPortal("driver")} type="button">Driver / Operator</button>
          <button className={`nav-tab ${portal === "parent" ? "active" : ""}`} onClick={() => setPortal("parent")} type="button">Parent</button>
          <button className={`nav-tab ${portal === "events" ? "active" : ""}`} onClick={() => setPortal("events")} type="button">Events</button>
        </nav>
      ...
      <main>
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <button className="secondary-action" onClick={() => { setPortal("operations"); setAdminSection("routes"); }} type="button">Add Route</button>
